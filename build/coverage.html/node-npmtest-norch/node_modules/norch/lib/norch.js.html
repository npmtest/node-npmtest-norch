...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-norch/node_modules/norch/lib/norch.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-norch">npmtest-norch (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-norch/node_modules/norch/lib/norch.js</span></h1>
    <h2>
        
        Statements: <span class="metric">91.23% <small>(52 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-norch/node_modules/norch/lib/</a> &#187; norch.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = function (options, callback) {
  ...
  var norchHome = options.norchHome || <span class="branch-1 cbranch-no" title="branch not covered" >'norch-index'</span>
    ...
    options = _.defaults(
      options, {
        ...
        log: new Logger.createLogger({ // eslint-disable-line
          name: 'norch',
          level: options.logLevel || <span class="branch-1 cbranch-no" title="branch not covered" >'info',</span>
          serializers: {
...
<span class="cstat-no" title="statement not covered" >              return {</span>
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (err) options.log.info(err)
    <span class="missing-if-branch" title="else path not taken" >E</span>if (process.argv.indexOf('-h') === -1) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.si) {
<span class="cstat-no" title="statement not covered" >        return startServer(options, callback)</span>
      } else {
        searchindex({
...
var startServer = function (options, callback) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.machineReadable) {
...
&nbsp;
  ...
  norch.pre(<span class="fstat-no" title="function not covered" >function (request, response, next) {</span>
<span class="cstat-no" title="statement not covered" >    request.log.info({</span>
      req: request,
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 25 2017 22:51:36 GMT+0000 (UTC)</div>
</div>
</body>
</html>
